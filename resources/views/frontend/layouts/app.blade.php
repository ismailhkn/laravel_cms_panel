...
@yield('css')
    ...
    <!-- ================== BEGIN BASE JS ================== -->
    <script src="{{ URL::asset('frontend') }}/plugins/pace/pace.min.js"></script>
    <!-- ================== END BASE JS ================== -->
</head>
...
<div id="page-container" class="fade">
    ...
    <div id="home" class="content has-bg home">
        ...
        <div class="content-bg">
            <img src="{{ URL::asset('frontend') }}/img/bg/bg-home.jpg" alt="Home" />
        </div>
        <!-- end content-bg -->
        <!-- begin container -->
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    ...
                    <div class="about-author">
                        ...
                        <div class="author">
                            <div class="image">
                                <img src="{{ URL::asset('frontend') }}/img/user/user-1.jpg" alt="Sean Ngu" />
                            </div>
                            <div class="info">
                                Sean Ngu
    ...
    <div id="milestone" class="content bg-black-darker has-bg" data-scrollview="true">
        <!-- begin content-bg -->
        <div class="content-bg">
            <img src="{{ URL::asset('frontend') }}/img/bg/bg-milestone.jpg" alt="Milestone" />
        </div>
        <!-- end content-bg -->
        <!-- begin container -->
        <div class="container">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="team">
                        <div class="image" data-animation="true" data-animation-type="flipInX">
                            <img src="{{ URL::asset('frontend') }}/img/user/user-1.jpg" alt="Ryan Teller" />
                        </div>
                        <div class="info">
                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="team">
                        <div class="image" data-animation="true" data-animation-type="flipInX">
                            <img src="{{ URL::asset('frontend') }}/img/user/user-2.jpg" alt="Jonny Cash" />
                        </div>
                        <div class="info">
                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="team">
                        <div class="image" data-animation="true" data-animation-type="flipInX">
                            <img src="{{ URL::asset('frontend') }}/img/user/user-3.jpg" alt="Mia Donovan" />
                        </div>
                        <div class="info">
    ...
    <div id="quote" class="content bg-black-darker has-bg" data-scrollview="true">
        <!-- begin content-bg -->
        <div class="content-bg">
            <img src="{{ URL::asset('frontend') }}/img/bg/bg-quote.jpg" alt="Quote" />
        </div>
        <!-- end content-bg -->
        <!-- begin container -->
    ...
    <div id="action-box" class="content has-bg" data-scrollview="true">
        <!-- begin content-bg -->
        <div class="content-bg">
            <img src="{{ URL::asset('frontend') }}/img/bg/bg-action.jpg" alt="Action" />
        </div>
        <!-- end content-bg -->
        <!-- begin container -->
        ...
        <div class="container" data-animation="true" data-animation-type="fadeInDown">
            ...
            <div class="row row-space-10">
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="work">
                        <div class="image">
                            <a href="#"><img src="{{ URL::asset('frontend') }}/img/work/work-img-1.jpg" alt="Work 1" /></a>
                        </div>
                        <div class="desc">
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="work">
                        <div class="image">
                            <a href="#"><img src="{{ URL::asset('frontend') }}/img/work/work-img-2.jpg" alt="Work 2" /></a>
                        </div>
                        <div class="desc">
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="work">
                        <div class="image">
                            <a href="#"><img src="{{ URL::asset('frontend') }}/img/work/work-img-3.jpg" alt="Work 3" /></a>
                        </div>
                        <div class="desc">
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="work">
                        <div class="image">
                            <a href="#"><img src="{{ URL::asset('frontend') }}/img/work/work-img-4.jpg" alt="Work 4" /></a>
                        </div>
                        <div class="desc">
            ...
            <div class="row row-space-10">
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="work">
                        <div class="image">
                            <a href="#"><img src="{{ URL::asset('frontend') }}/img/work/work-img-5.jpg" alt="Work 5" /></a>
                        </div>
                        <div class="desc">
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="work">
                        <div class="image">
                            <a href="#"><img src="{{ URL::asset('frontend') }}/img/work/work-img-6.jpg" alt="Work 6" /></a>
                        </div>
                        <div class="desc">
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="work">
                        <div class="image">
                            <a href="#"><img src="{{ URL::asset('frontend') }}/img/work/work-img-7.jpg" alt="Work 7" /></a>
                        </div>
                        <div class="desc">
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="work">
                        <div class="image">
                            <a href="#"><img src="{{ URL::asset('frontend') }}/img/work/work-img-8.jpg" alt="Work 8" /></a>
                        </div>
                        <div class="desc">
    ...
    <div id="client" class="content has-bg bg-green" data-scrollview="true">
        <!-- begin content-bg -->
        <div class="content-bg">
            <img src="{{ URL::asset('frontend') }}/img/bg/bg-client.jpg" alt="Client" />
        </div>
        <!-- end content-bg -->
        <!-- begin container -->
    ...
    <div class="theme-panel">
        ...
        <div class="theme-panel-content">
            <ul class="theme-list clearfix">
                <li><a href="javascript:;" class="bg-purple" data-theme="purple" data-theme-file="{{ URL::asset('frontend') }}/css/one-page-parallax/theme/purple.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Purple">&nbsp;</a></li>
                <li><a href="javascript:;" class="bg-blue" data-theme="blue" data-theme-file="{{ URL::asset('frontend') }}/css/one-page-parallax/theme/blue.css" data-theme-file="" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Blue">&nbsp;</a></li>
                <li class="active"><a href="javascript:;" class="bg-green" data-theme-file="{{ URL::asset('frontend') }}/css/one-page-parallax/theme/default.css" data-theme-file="" data-theme="default" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Default">&nbsp;</a></li>
                <li><a href="javascript:;" class="bg-orange" data-theme="orange" data-theme-file="{{ URL::asset('frontend') }}/css/one-page-parallax/theme/orange.css" data-theme-file="" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Orange">&nbsp;</a></li>
                <li><a href="javascript:;" class="bg-red" data-theme="red" data-theme-file="{{ URL::asset('frontend') }}/css/one-page-parallax/theme/red.css" data-theme-file="" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Red">&nbsp;</a></li>
            </ul>
        </div>
    </div>
    <!-- end theme-panel -->
...
<!-- ================== BEGIN BASE JS ================== -->
<script src="{{ URL::asset('frontend') }}/plugins/jquery/jquery-3.2.1.min.js"></script>
<script src="{{ URL::asset('frontend') }}/plugins/bootstrap3/js/bootstrap.min.js"></script>
<!--[if lt IE 9]>
<script src="{{ URL::asset('frontend') }}/crossbrowserjs/html5shiv.js"></script>
<script src="{{ URL::asset('frontend') }}/crossbrowserjs/respond.min.js"></script>
<script src="{{ URL::asset('frontend') }}/crossbrowserjs/excanvas.min.js"></script>
<![endif]-->
<script src="{{ URL::asset('frontend') }}/plugins/js-cookie/js.cookie.js"></script>
<script src="{{ URL::asset('frontend') }}/plugins/scrollMonitor/scrollMonitor.js"></script>
<script src="{{ URL::asset('frontend') }}/js/one-page-parallax/apps.min.js"></script>
<!-- ================== END BASE JS ================== -->
